package com.wellsen.fragments.test;

import com.wellsen.fragments.MainActivity;
...
public class PhoneTest extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public void testRun() {
		...
		// Wait for activity: 'com.wellsen.fragments.MainActivity'
		assertTrue("MainActivity not found", solo.waitForActivity(
				com.wellsen.fragments.MainActivity.class, delay));
		...
		assertTrue("ladygaga feed_view not found", solo.waitForView(solo
				.getView(com.wellsen.fragments.R.id.feed_view)));
