...
public class ExplicitTest extends
	...
	public void testRun() {
		...
		solo.clickOnView(solo
				.getView(com.wellsen.intents.R.id.explicit_activation_button));

		// Wait for activity: 'com.wellsen.intents.ExplicitlyLoadedActivity'
		assertTrue(
				"ExplicitTest:" + "Section One:"
						+ "ExplicitlyLoadedActivity did not load correctly",
				solo.waitForActivity(com.wellsen.intents.ExplicitlyLoadedActivity.class, delay));
		...
		assertEquals(
				...
				"Intent { cmp=com.wellsen.intents/.ExplicitlyLoadedActivity }",
		...
		solo.clearEditText((android.widget.EditText) solo
				.getView(com.wellsen.intents.R.id.editText));

		// Enter the text: 'test'
		solo.enterText((android.widget.EditText) solo
				.getView(com.wellsen.intents.R.id.editText), "test");
