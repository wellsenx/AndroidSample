...
public class OldFeedNoNotificationTest extends
	...
	public void testRun() {
		...
		solo.waitForActivity(
				com.wellsen.notifications.TestFrontEndActivity.class, shortDelay);
		...
		assertTrue("com.wellsen.notifications.MainActivity is not found!",
				solo.waitForActivity(
						com.wellsen.notifications.MainActivity.class, shortDelay));

		// Assert that: Toast message is shown
		String msg = getActivity().getString(com.wellsen.notifications.R.string.download_in_progress_string);
		...
		String failMsg = getActivity().getString(com.wellsen.notifications.R.string.download_failed_string);
		String successMsg = getActivity().getString(com.wellsen.notifications.R.string.download_succes_string);
		...
		assertTrue("feed_view' is not shown!", solo.waitForView(solo
				.getView(com.wellsen.notifications.R.id.feed_view)));
