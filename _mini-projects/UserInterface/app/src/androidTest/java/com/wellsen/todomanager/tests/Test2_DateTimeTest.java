...
public class Test2_DateTimeTest extends ActivityInstrumentationTestCase2<ToDoManagerActivity> {
	...
	public void testRun() {
		...
		solo.enterText((android.widget.EditText) solo
				.getView(com.wellsen.todomanager.R.id.title), "t1");
		...
		solo.clickOnView(solo
				.getView(com.wellsen.todomanager.R.id.date_picker_button));
		...
		solo.clickOnView(solo
				.getView(com.wellsen.todomanager.R.id.time_picker_button));
		...
		assertTrue("DateTimeTest failed:" +
				...
				solo.waitForActivity(
						com.wellsen.todomanager.ToDoManagerActivity.class, delay));
