...
public class BubbleActivityFloatOffScreen extends
	...
	public void testRun() {
		...
		solo.waitForActivity(com.wellsen.graphics.BubbleActivity.class,
				delay);

		// Click on action bar item
		solo.clickOnActionBarItem(com.wellsen.graphics.R.id.menu_single_speed);
		...
		boolean bubbleAppeared = solo.getCurrentViews(
				com.wellsen.graphics.BubbleActivity.BubbleView.class).size() > 0;
